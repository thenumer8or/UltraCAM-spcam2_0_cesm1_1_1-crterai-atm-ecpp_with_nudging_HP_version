...
#ifdef LIBERATE_BL
   real(r8)      :: dlat,dlon,my_lat,my_lon,my_lon_shifted,fhorizontal,fvertical,fvertical_reverse,fnep,fsep,fnamb,ftot_reverse,ftots,ftotu,ftotv
#endif
...
! HP: Not sure if phys_state%pmid handle is accessible in this routine.
   ...
   dlon = 60.0;      !2nd experiment
   dlat = 80.0;      !2nd experiment
!   dlon = 15.0;      !1st experiment
!   dlat = 20.0;      !1st experiment
...
! Coefficient to horizontally limit the nudging
      ...
      fhorizontal = min (0.2+fnep+fsep+fnamb, 1.0)
...
! Combine the horizontal and vertical nudging coefficients
         ftot_reverse = fvertical_reverse * fhorizontal
!         ftot_reverse = fhorizontal
         ftots        = 1.0 - ftot_reverse 
         ftotu        = 1.0 - ftot_reverse 
         ftotv        = 1.0 - ftot_reverse

! Deny nudging to the first few model levels near the surface 
         if (k .gt. pver-4) then
          ftots = 0.0
          ftotu = 0.0
          ftotv = 0.0

          !write (iulog,*) 'Pressure at this level = ', phys_state%pmid(i,k)
         endif
